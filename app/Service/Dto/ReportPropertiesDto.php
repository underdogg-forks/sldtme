...
class ReportPropertiesDto implements Castable
{
    ...
    {
        $this->memberIds = $memberIds !== null ? self::idArrayToCollection($memberIds) : null;
    }
    ...
    {
        $this->clientIds = $clientIds !== null ? self::idArrayToCollection($clientIds) : null;
    }
    ...
    {
        $this->projectIds = $projectIds !== null ? self::idArrayToCollection($projectIds) : null;
    }
    ...
    {
        $this->tagIds = $tagIds !== null ? self::idArrayToCollection($tagIds) : null;
    }
    ...
    {
        $this->taskIds = $taskIds !== null ? self::idArrayToCollection($taskIds) : null;
    }
}
